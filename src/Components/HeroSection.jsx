        ...
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <div className="space-y-4 sm:flex sm:space-y-0 sm:!space-x-4">
            <Button
              ...
              link={"#"}
              className={
                "!inline-flex !items-center !justify-center !w-full !px-5 !py-3 !text-center !text-gray-900 !border !border-gray-200 sm:!w-auto hover:!bg-gray-100  focus:!ring-gray-100 dark:!text-white dark:!border-gray-700 dark:!bg-transparent dark:hover:!bg-gray-700 dark:focus:!ring-gray-800"
              }
            />
